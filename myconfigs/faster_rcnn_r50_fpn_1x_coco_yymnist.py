model = dict(
    ...
    backbone=dict(
        ...
        depth=50,
        num_stages=4,
        out_indices=(0, 1, 2, 3), #输出索引 对应输出维度[256, 512, 1024, 2048],
        frozen_stages=1,
    ...
    neck=dict(
        type='FPN',
        in_channels=[256, 512, 1024, 2048], #与backbone输出维度一致[256, 512, 1024, 2048]
...
resume_from = None
workflow = [('train', 1)]
work_dir = './tutorial_exps/faster_rcnn/yymnist'
seed = 0
gpu_ids = range(0, 1)
