...
selected_model = 'mask_rcnn_swin-t-p4-w7_fpn_1x_coco' 
total_epochs = 20
...
print(f'Config:\n{cfg.pretty_text}')
#with open("myconfigs/mask_rcnn_swin-t-p4-w7_fpn_1x_coco.py","w+") as f:
...
if __name__ == '__main__':  
    ...
    cfg = Config.fromfile("myconfigs/mask_rcnn_swin-t-p4-w7_fpn_1x_coco.py") 
