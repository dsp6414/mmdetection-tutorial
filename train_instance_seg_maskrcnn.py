...
MODELS_CONFIG = {
    'mask_rcnn_r50_fpn_1x_coco': {
        'config_file': 'configs/balloon/mask_rcnn_r50_fpn_1x_coco.py'
    }
}

selected_model = 'mask_rcnn_r50_fpn_1x_coco' 
total_epochs = 20
...
print(f'Config:\n{cfg.pretty_text}')
#with open("myconfigs/mask_rcnn_r50_fpn_1x_coco_balloon.py","w+") as f:
...
if __name__ == '__main__':  
    ...
    cfg = Config.fromfile("myconfigs/mask_rcnn_r50_fpn_1x_coco_balloon.py") 
